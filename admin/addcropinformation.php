          ...
          <div class="col-md-4">
            <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">Crop Information in Database</h3>
              </div>
              <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                  <div class="form-outline">
                                    <input type="text" name="CropName" class="form-control form-control-lg" style="width:200px;border-radius:10px;font-family:'Calibri';" placeholder="Crop Name" required>
                                  </div>
                                </div>
